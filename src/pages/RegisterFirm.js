  ...
  async function registerRequest() {
    ...
    try {
      if (!privacyAgreementChecked) {
        ...
        let res = await axios.post("http://localhost:9090/register/firm", {
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.inputContainer}>
        ...
        <input ref={contactInformationRef} id="contactInformation" type="text" placeholder="ContactInformation"/>
